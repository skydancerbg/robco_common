...
function SignalingChannel(sessionId) {
    ...
    var es = new EventSource("http://" + window.location.hostname + ":8081/stoc/" + sessionId + "/" + userId);
    ...
    function PeerChannel(peerUserId) {
        ...
        function processSendQueue() {
            ...
            xhr.open("POST", "http://" + window.location.hostname + ":8081/ctos/" + sessionId + "/" + userId + "/" + peerUserId);
