...
NAV2D.ImageMapClientNav = function(options) {
  ...
  client.on('change', function() {
    ...
    that.viewer.image_dim = {w : client.currentImage.width, h : client.currentImage.height};
...
NAV2D.Navigator = function(options) {
  ...
  poseListener.subscribe(function(pose) {
    ...
    $("#position_x").text((pose.position.x).toFixed(2));
    $("#position_y").text((pose.position.y).toFixed(2));
    $("#heading").text((robotMarker.rotation).toFixed(0));
  });
